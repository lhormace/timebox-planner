      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        <Section title="タイムライン操作">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong>タスクブロックをクリック</strong> — 配置管理ダイアログを開く（日ごとの配置一覧・追加・削除、編集・削除への導線）</li>
        ...
        <Section title="データの保存について">
          ...
          <p>
            設定画面の「データの保存・読み込み」から、データをJSONファイルとしてダウンロード／読み込みできます。
            バックアップや他の端末・ブラウザへの引き継ぎに利用してください。
          </p>
          <p>
            Chrome・Edgeなど対応ブラウザでは、ローカルの特定ファイルを選んで直接保存・同期することもできます
            （「ファイルを選んで保存」「ファイルから同期して開く」）。ファイルとの紐付けはタブを閉じるとリセットされます。
          </p>
        </Section>
      </main>
    </div>
